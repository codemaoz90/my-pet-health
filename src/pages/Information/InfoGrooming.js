    ...
    return(
        <Container fluid className="info d-flex flex-column justify-content-center align-items-center">
            <Row>
                <Col>
                    <Link to="info_health">
                        <BsArrowLeftShort size={40} className="arrow" alt="arrow" /> 
                    </Link>
                </Col>
            </Row>
            ...
            <Row className="d-flex flex-column mt-5">
                <Col>
                    <p className="info-title d-flex justify-content-center">Beauty routine</p>
                </Col>

                <Col className="mt-4">
                    <p className="info-paragraph d-flex justify-content-center">
                        Take care of your pet’s appearance. Use our base of Beauty Specialists.</p>
                </Col>
            </Row>
